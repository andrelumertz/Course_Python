...
sum = num1 + num2 #soma = num1 + num2
sub = num1 - num2 #subtração = num1 - num2
div = num1 / num2 #divisão = num1 / num2
mult = num1 * num2 #multiplicação = num1 * num2
mod = num1 % num2 #resto da divisão = num1 % num2
exp = num1 ** num2 #potência = num1 ** num2
